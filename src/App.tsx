...
function ProjectOverlay({
  ...
  const projectInfo = [
    {
      title: "JustTrampIt",
      desc: "A tramp planning app built with JavaFX with a team of 5 people for a second year Software Engineering project course.",
      link: "https://github.com/Ed-Leonard/JustTrampIt",
    },
    {
      title: "Racing Game",
      desc: "A very basic 2D game built with JavaFX with a partner completed as an introduction to Java.",
      link: "https://github.com/Ed-Leonard/SENG201-Game",
    },
    {
      title: "Portfolio",
      desc: "Inception... Built with React, Typescript, Tailwind, and React Three Fiber to create the interactive 3D scene. Because it's fun.",
      ...
      <motion.div className="flex flex-col items-center justify-center bg-[#282828] text-white transition-all h-auto">
        ...
        <AnimatePresence initial={false}>
          {projects && (
            ...
            >
              <p className="absolute border rounded-lg max-w-64 m-4 p-2 animate-[pulse_2s_ease-in-out_5]">
